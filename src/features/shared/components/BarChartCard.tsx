...
import { CustomFilledButton, exportToExcel, type BarChartDatum, type ExportExcelOptions } from "@/features/shared/shared";
import { Download } from "lucide-react";
import type { TooltipContentProps } from "recharts";

const BAR_COLOR = "#2a78d6";

const DEFAULT_EXCEL_COLUMNS: ExportExcelOptions<BarChartDatum>["columns"] = [
    { header: "Categoría", key: "label" },
...
export function BarChartCard({ title, data, excelColumns = DEFAULT_EXCEL_COLUMNS }: BarChartCardProps) {
    const handleExportToExcel = () => {
        exportToExcel<BarChartDatum>({
            fileName: title,
            sheetName: title,
